...
**任务**：将根目录 `README.md` 从英文说明翻译为中文说明，保持现有结构、命令、路径和契约字段不变，降低项目使用门槛。

**方案**：
1. 逐段翻译标题、段落和项目符号，保留代码块、路径、字段名与命令原样
2. 不改动已有项目事实、验证命令或输出字段，仅做语言层转换
3. 同步更新 `CHANGELOG.md` 记录本次文档翻译任务
